...
const MainLayout = () => {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex fixed right-4 top-1/3 z-50 flex-col items-center gap-4 text-yellow-500 bg-black/10 backdrop-blur-md p-3  shadow-lg mr-2">
        {socialMediaLinks.map((link, index) => (
          <a
            ...
            className="hover:text-yellow-300 transition border-2 border-yellow-500 p-2 rounded-full hover:bg-yellow-800"
          >
            {link.icon}
          </a>
        ))}
