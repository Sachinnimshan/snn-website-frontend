            ...
            >
              ...
              <div className="flex flex-wrap gap-3 mt-3">
                ...
                <a
                  ...
                  className="bg-primaryWhiteColor text-secondaryColor inline-flex items-center gap-1 px-4 py-1.5 rounded-lg font-semibold uppercase text-sm cursor-default 
