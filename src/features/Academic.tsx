      ...
      {isLoading ? (
        ...
        <VerticalTimeline>
          {data?.map((item) => (
            ...
            >
              <span className="flex align-center gap-2 text-base font-bold text-gray-600 dark:text-yellow-300">
                <FaMedal size={20} className="text-gray-500" />
                {item.title}
              </span>
              <span className="flex align-center gap-2 text-md font-medium text-yellow-600 dark:text-yellow-400 mt-2">
